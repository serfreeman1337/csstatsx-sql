...
* Для обновления с **CsStats MySQL** выполните импорт **csstats_mysql_convert.sql**, после выполните импорт **csstats_06_to_07.sql** (обратите внимание на название таблицы в sql файле).
